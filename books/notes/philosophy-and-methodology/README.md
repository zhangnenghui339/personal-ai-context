# 哲学、认知与思维模型 (Philosophy & Mental Models)

本目录沉淀中西方哲学、认识论、心智模型与跨学科思维武器库。

## 包含书目与核心模型

- `dao-de-jing.md`：《道德经》（无积予人、为道日损、反例机制制度化、AI SaaS实战沙盘、Model C 四自因果链、第二十九章「将欲取天下而为之」顺道而为模型、默多克 Fallen 与 Fat Relentless Ego 认知透镜、第十二/十五/二十章为腹不为目与浊静徐清、第七章后身外身模型、12大反事实日损工具、反者道之动、无为而治）| [导图源](https://docs.qq.com/mind/DSHlDUVZncXpwQWNy)
...
- `zhuangzi-core-thought-wuji-xinzhai-zuowang.md`：《庄子》核心思想（成心、无己、心斋、坐忘、齐物、物化、无用之用；逍遥≠逃避：无待解除人质而非关系）
